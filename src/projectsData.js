const projects = [
  {
    ...
    url: "https://github.com/dnd1993/Portfolio-Project",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    name: "Grocery List Project",
    about:
      "CRUD project created with useReducer. Working with React Hooks and Local Storage",
    background: "#f0d9d7",
    alt: "Groceries logo",
    img: "/img/shop.png",
...

  {
    id: 4,
    name: "Filter Project",
    about: "Filtering, searching for products (Vanilla JS). CSS. ",
    background: "#f5e4e3",
    alt: "Doughnut Logo",
...

  {
    ...
    name: "Quiz Project",
    about:
      "Conditional rendering, working with arrays (Vanilla JS). Note: not responsive",
    background: "#f7e9e8",
    alt: "9 3/4 logo",
    img: "/img/harry.png",
  ...
  },
  {
    id: 6,
    name: "Tips Project",
    about: "IIFE, event listeners, working with inputs",
    background: " #f9efee",
    alt: "Dollar logo",
    img: "/img/tips.png",
